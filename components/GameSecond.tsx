...
const Game = () => {
 ...
 const { score, setScore } = useScore();
  ...
  const imageData = [
    { id: 'Dog', uri: 'https://ik.imagekit.io/zmuooch5m/Frame.png?updatedAt=1754382721442' },
    { id: 'Cat', uri: 'https://ik.imagekit.io/zmuooch5m/Frame%20(1).png?updatedAt=1754382721431' },
  ];
 ...
 const handleSubmit = async () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FCEFBB", padding: 15 }}>
